...
type LengthStrategy = "varied" | "short" | "medium" | "long";
type DraftStatus = "draft" | "published" | "deleted";

interface RawCandidateArticle {
  id: string;
  title: string;
  source_name: string;
  url: string;
...
interface ReviewItem extends DailyGeneratedItem {
  status: DraftStatus;
}
...
const ITEM_STATUS_CLASSES: Record<DraftStatus, string> = {
  draft: "bg-blue-100 text-blue-800",
  published: "bg-green-100 text-green-800",
  deleted: "bg-red-100 text-red-800",
};

const LENGTH_OPTIONS: Array<{ value: LengthStrategy; label: string }> = [
...
function publishPriority(type: DailyItemType) {
  switch (type) {
    case "news_reaction":
      return 0;
    case "cross_reply":
